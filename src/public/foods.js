      ...
      function loadState() {
        ...
        if (document.getElementById("syncDataId")) {
          document.getElementById("syncDataId").value =
            state.syncConfig.id || "";
      ...
      function addFood() {
        ...
        const price =
          parseInt(document.getElementById("newFoodPrice").value) || 0;
        const quantity =
      ...
      function resetFoodRemaining(id) {
          ...
          return foods
            .map((f) => {
              ...
              <div style="display:flex;gap:4px;">
                ...
                <button class="btn-icon" title="残量をリセット" onclick="resetFoodRemaining('${f.id}')">🔄</button>
      ...
      function renderRecords() {
        ...
        el.innerHTML = sortedDates
          .map((date) => {
            ...
            recs.sort((a, b) => (MEAL_ORDER[a.mealTime] || 5) - (MEAL_ORDER[b.mealTime] || 5));
      ...
      function saveRecordEdit() {
        ...
        if (r.type === "cooking" || r.type === "prepmake") {
          ...
          r.restaurantName = document
            .getElementById("editRecordNote")
            .value.trim();
        }
      ...
      function renderCharts() {
        ...
        monthRecords.forEach((r) => {
          mealGroups[r.mealTime] =
            (mealGroups[r.mealTime] || 0) + (r.totalCost || 0);
        });
